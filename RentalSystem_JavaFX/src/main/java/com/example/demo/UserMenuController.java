...
public class UserMenuController {
    ...
    public void buttonOnClick(ActionEvent event) throws IOException {
        ...
        if (clickedButton == viewButton) {
            ...
            root = FXMLLoader.load(getClass().getResource("user_view.fxml"));
            ...
            stage = (Stage) viewButton.getScene().getWindow();
            root = FXMLLoader.load(getClass().getResource("user_filtered.fxml"));
        }else if(clickedButton==rentButton){
            stage = (Stage) viewButton.getScene().getWindow();
            root = FXMLLoader.load(getClass().getResource("user_rent.fxml"));
        }
