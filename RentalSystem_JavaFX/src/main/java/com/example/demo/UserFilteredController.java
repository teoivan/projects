...
public class UserFilteredController {
    ...
    public Map<Integer, List<Property>> propertiesByBedrooms=propertyManager.propertiesByBedrooms();
    public Map<String, List<Property>> propertiesByType=propertyManager.propertiesByType();
    @FXML
